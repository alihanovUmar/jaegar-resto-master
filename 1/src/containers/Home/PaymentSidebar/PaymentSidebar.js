      ...
      <form id="payment-form">
        ...
        <div className="payment-main">
          ...
          <div className="payment-method">
            <label htmlFor="payment-credit-card" className="payment-card-label">
              {<CreditCardIcon />}
              <h4>Credit Card</h4>
              <input
                type="radio"
            ...
            <label htmlFor="payment-cash" className="payment-card-label cash">
              {<CashCardIcon />}
              <h4>Cash</h4>
          ...
          <label htmlFor="card-number" className="payment-label card-number">
          ...
          <div className="card-foot">
            ...
            <label htmlFor="card-cvv" className="payment-label card-cvv">
              <h4>CVV</h4>
              <input
                type="password"
                name="card_cvv"
        ...
        <div className="payment-foot">
          <div className="additional-inputs">
            <label htmlFor="order-type" className="payment-label order-type">
              <h4>Order Type</h4>
            ...
            <label htmlFor="table-no" className="payment-label table-no">
              <h4>Table no.</h4>
              <input
                type="number"
                name="card_table_no"
